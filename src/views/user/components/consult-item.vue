...
import { useCancelOrder, useDeleteOrder } from '@/composable/index'
import { OrderType } from '@/enums'
import type { patientConsultOrderListDataRow } from '@/types/user'
import { computed, ref } from 'vue'
const { item } = defineProps<{ item: patientConsultOrderListDataRow }>()
...
// 取消订单
const { loading, orderCancel } = useCancelOrder()

// 删除订单
const { deleteLoading, deleteOrder } = useDeleteOrder(() => {
